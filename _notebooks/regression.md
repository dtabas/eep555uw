...
Provided you've installed Jupyter via [Anaconda](https://www.anaconda.com/) the required libraries will be available. Jupyter is a useful development environment for sharing your work in notebooks like the one you're reading. The namespace of an active notebook is persistent across cells and cell executions, so keep track of your variable names! This notebook can be found at [github.com/dtabas/ee555/tree/main/hw1](https://github.com/dtabas/ee555/tree/main/hw1). The markdown notebook on this page is for display only. You can download the ipynb file from the repository directly or clone the entire repository by using [Git](https://github.com/) (recommended).
